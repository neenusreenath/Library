...
<body>
	...
	<div class="wrapper" id="wrapper">
					...
					<div class="col-lg-8 d-none d-lg-block">
						<nav class="mainmenu__nav">
							<ul class="meninmenu d-flex justify-content-start">
								<li class="drop with--one--item "><a class="text-warning" href="/library">Home</a></li><br>
								...
								<li>
    								...
    								<div class="dropdown-menu">
      									...
      									<a class="dropdown-item" href="{{url('descsort')}}">Descending</a>
	            			...
	            			<div class="slider__content">
		            			<div class="contentbox">
		            				...
		            				<h2> <span>World..</span></h2>
				                   	<a class="shopbtn" href="/library/create">Add Your Book Here</a>
		            			</div>
	            			</div>
	            		</div>
	            	</div>
		...
		<div class="col-lg-12">
			...
			<form class="form-inline form-group" action="{{url('search')}}">
  
  				<input type="text" class="form-control col-lg-10" placeholder="Search Your Book Here.." name="search">
  				<button type="submit"   class=" btn btn-success form-control col-lg-2">Search</button>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="copyright">
								<div class="copy__right__inner text-left">
									<p>Copyright <i class="fa fa-copyright"></i> <a href="{{asset('https://freethemescloud.com/')}}">Free themes Cloud.</a> All Rights Reserved</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
